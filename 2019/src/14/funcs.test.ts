...
const example2 = parseReactions(`9 ORE => 2 A
8 ORE => 3 B
7 ORE => 5 C
3 A, 4 B => 1 AB
5 B, 7 C => 1 BC
...
const example3 = parseReactions(`157 ORE => 5 NZVS
165 ORE => 6 DCFZ
...
const example4 = parseReactions(`2 VPVL, 7 FWMGM, 2 CXFTF, 11 MNCFX => 1 STKFG
...
const example5 = parseReactions(`171 ORE => 8 CNZTR
...
test("getRequiredOre", () => {
  expect(getRequiredOre(example1)).toBe(31);
  expect(getRequiredOre(example2)).toBe(165);
